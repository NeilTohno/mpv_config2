...
ffmpeg -hide_banner -i %1 -c:a:0 pcm_f32le -af "pan=stereo|FL<0.707*FC+1.000*FL+0.707*SL+0.707*BL+0.000*LFE|FR<0.707*FC+1.000*FR+0.707*SR+0.707*BR+0.000*LFE, aresample=osr=192000:osf=fltp:cutoff=1.00:resampler=soxr:precision=33:cheby=1, loudnorm=I=!loudness!:TP=!truepeak!:LRA=!loudrange!:print_format=json" -f null - 2>%1.txt
